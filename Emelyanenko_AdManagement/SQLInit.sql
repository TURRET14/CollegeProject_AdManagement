...
CREATE TABLE Adverts (ID INT PRIMARY KEY IDENTITY(0, 1), UserID INT REFERENCES Users NOT NULL, Ad_Title VARCHAR(250) NOT NULL, Ad_Description VARCHAR(500) NOT NULL, Ad_Post_Date DATE NOT NULL, CityID INT REFERENCES Cities NOT NULL, CategoryID INT REFERENCES Categories NOT NULL, Ad_TypeID INT REFERENCES Ad_Types NOT NULL, Ad_StatusID INT REFERENCES Ad_Statuses NOT NULL, Price INT NOT NULL);
